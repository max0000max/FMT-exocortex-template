...
for repo in $(ls /home/user/IWE/); do
  if [ -d /home/user/IWE/$repo/.git ]; then
    commits=$(git -C /home/user/IWE/$repo log --since="today 00:00" --oneline --no-merges 2>/dev/null)
...
/home/user/IWE/FMT-exocortex-template/roles/synchronizer/scripts/day-close.sh
```
