...
|-------|------|---------|------|
| _Твой домен (напр. Machine Learning)_ | _PACK-my-domain_ | _MD_ | _/home/user/IWE/PACK-my-domain/pack/my-domain/_ |
...
| Правило (глобальное) | `rule` | `/home/user/IWE/CLAUDE.md` | Строки |
...
|---------|--------|-------------|
| _Мой бот_ | _your-org/my-bot_ | _/home/user/IWE/your-org/my-bot/docs/_ |
