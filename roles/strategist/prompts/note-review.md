...
| 3 | **Знание доменное** | Паттерн, различение, метод, правило — применимо вне реализации | → запись в inbox/captures.md |
...
| 6 | **Личные данные** | Контакт, телефон, email, токен, аккаунт, реквизиты | → personal/*.md |
...
| Знание доменное | `**Заголовок**` | `Заголовок` (снять bold) |
| Знание реализационное | `**Заголовок**` | `Заголовок` (снять bold) |
