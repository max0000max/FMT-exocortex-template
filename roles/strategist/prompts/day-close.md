...
- **WeekPlan:** /home/user/IWE/DS-strategy/current/WeekPlan W*.md (последний по дате)
- **MEMORY:** ~/.claude/projects/-home-user-IWE/memory/MEMORY.md
- **Exocortex backup:** /home/user/IWE/DS-strategy/exocortex/
...
```bash
# Для КАЖДОГО репо в /home/user/IWE/:
git -C /home/user/IWE/<repo> log --since="today 00:00" --oneline --no-merges
```

- Пройди по ВСЕМ репозиториям в `/home/user/IWE/`
...
Скопируй актуальные файлы в `/home/user/IWE/DS-strategy/exocortex/`:

```bash
# Корневой CLAUDE.md
cp /home/user/IWE/CLAUDE.md /home/user/IWE/DS-strategy/exocortex/CLAUDE.md

# Memory (Слой 3)
cp ~/.claude/projects/-home-user-IWE/memory/MEMORY.md /home/user/IWE/DS-strategy/exocortex/MEMORY.md
cp ~/.claude/projects/-home-user-IWE/memory/*.md /home/user/IWE/DS-strategy/exocortex/
```
